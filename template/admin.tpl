      ...
      <div class="iconBox" id="iconBox_{$icons.id}">
        ...
        <div class="iconShot">
          <ul>
            ...
            <li><a href="#" title="{if $favorite.IS_FAVORITE}{'delete this photo from your favorites'|@translate}{else}{'add this photo to your favorites'|@translate}{/if}" class="pwg-state-default pwg-button" rel="nofollow"> <span class="pwg-icon pwg-icon-favorite-add"> </span><span class="pwg-button-text">{'Favorites'|@translate}</span> </a></li>
